...
CREATE TABLE public.elevation_profile_cleanup_jobs (
    ...
    CONSTRAINT elevation_profile_cleanup_jobs_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'processing'::text, 'succeeded'::text, 'failed'::text])))
);
...
CREATE TABLE public.elevation_profile_jobs (
    ...
    CONSTRAINT elevation_profile_jobs_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'processing'::text, 'succeeded'::text, 'failed'::text])))
);
...
-- Owner will be set automatically for table weather_temperature_series
...
-- Owner will be set automatically for table yearly_analysis_weather_revisions
...
--
-- Name: elevation_profile_cleanup_jobs elevation_profile_cleanup_jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.elevation_profile_cleanup_jobs
    ADD CONSTRAINT elevation_profile_cleanup_jobs_pkey PRIMARY KEY (id);


--
-- Name: elevation_profile_cleanup_jobs elevation_profile_cleanup_jobs_trip_id_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.elevation_profile_cleanup_jobs
    ADD CONSTRAINT elevation_profile_cleanup_jobs_trip_id_key UNIQUE (trip_id);


--
-- Name: elevation_profile_jobs elevation_profile_jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.elevation_profile_jobs
    ADD CONSTRAINT elevation_profile_jobs_pkey PRIMARY KEY (id);


--
-- Name: elevation_profile_jobs elevation_profile_jobs_trip_id_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.elevation_profile_jobs
    ADD CONSTRAINT elevation_profile_jobs_trip_id_key UNIQUE (trip_id);
...
--
-- Name: elevation_profile_cleanup_jobs_status_available_at_idx; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX elevation_profile_cleanup_jobs_status_available_at_idx ON public.elevation_profile_cleanup_jobs USING btree (status, available_at);


--
-- Name: elevation_profile_jobs_status_available_at_idx; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX elevation_profile_jobs_status_available_at_idx ON public.elevation_profile_jobs USING btree (status, available_at);
...
--
-- Name: elevation_profile_jobs elevation_profile_jobs_trip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.elevation_profile_jobs
    ADD CONSTRAINT elevation_profile_jobs_trip_id_fkey FOREIGN KEY (trip_id) REFERENCES public.gtfs_trips(id) ON DELETE CASCADE;
