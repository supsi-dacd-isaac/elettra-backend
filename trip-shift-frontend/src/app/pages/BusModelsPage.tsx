            ...
            <li key={m.id} className="border rounded-lg p-2">
              {editingId === m.id ? (
                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="flex gap-2">
                    <button className="px-2 py-1 rounded text-white text-sm hover:opacity-90" style={{backgroundColor: '#002AA7'}} onClick={() => { setEditingId(m.id); setEditing({}); }}>{t('common.edit')}</button>
