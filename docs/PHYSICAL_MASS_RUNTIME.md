...
passenger_mass = passenger_count × 70 kg
...
1. TPF test specs (`empty=10235 kg`, ten 275 kg packs, capacity 70) produce
   12,985 kg at 0%, 15,435 kg at 50% and 17,885 kg at 100% occupancy.
...
4. Model metadata records fixed Solaris chassis coefficients, the hourly
   profile, the 50% mean anchor and the passenger weight convention.
